...
import CinemaSVG from "../images/interests/cinema.inline.svg"
import FinTechSVG from "../images/interests/fintech.inline.svg"
import FitnessSVG from "../images/interests/fitness.inline.svg"
...
export const interests = [
  ...
  {
    title: "Astronomy",
    icon: <AstronomySVG className="interest-icon" />,
  },
  {
    title: "Battlestations",
    icon: <BattlestationsSVG className="interest-icon" />,
  },
  {
    title: "Cinema",
    icon: <CinemaSVG className="interest-icon" />,
  },
  {
    title: "Fin-Tech",
    icon: <FinTechSVG className="interest-icon" />,
  },
  {
    title: "Fitness",
    icon: <FitnessSVG className="interest-icon" />,
  },
  {
    title: "Gaming",
    icon: <GamingSVG className="interest-icon" />,
  },
  {
    title: "Hip Hop",
    icon: <HipHopSVG className="interest-icon" />,
  },
  {
    title: "Networking",
  ...
  {
    title: "Traveling",
    icon: <TravelingSVG className="interest-icon" />,
  },
  {
